...
class ScrollBox(Widget):
    ...
    def draw(self, window: Window):
        ...
        if self.offset_length != 0:
            window.draw_rect(self.slider_rect[:2], self.slider_rect[2:], (200, 200, 200, 200))
...
def HoverBox(window: Window, rect: list, text: list, translator=None):
    ...
    text: [("text", (r, g, b, a))]
    """
    window.draw_rect(rect[:2], rect[2:], (150, 150, 150, 240))
...
class Menu:
    def __init__(self, window: Window):
        ...
        button_main_play = Button(self.main_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, columnspan=2, text="Play", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_main_settings = Button(self.main_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, text="Settings", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        Button(self.main_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=1, callback=window.quit, text="Quit", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        ...
        button_pause_play = Button(self.pause_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, text="Play", callback=button_pause_play_update, fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_pause_menu = Button(self.pause_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, text="Main Menu", callback=button_pause_menu_update, fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        ...
        button_settings_video_open = Button(settings_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, text="Video Settings", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_settings_audio_open = Button(settings_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=1, text="Audio Settings", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_settings_control_open = Button(settings_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, text="Control Settings", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_settings_world_open = Button(settings_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=1, text="World Settings", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_settings_back = Button(settings_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, columnspan=2, callback=self.main_page.open, text="Back", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        ...
        ###---###  Video settings page  ###---###
        settings_video_page = Page(parent=settings_page, spacing=MENU_SPACING)
        ...
        settings_video_scrollbox = ScrollBox(settings_video_page, (MENU_BUTTON_WIDTH + MENU_SPACING, 1), row=2, column=0, columns=2, spacing=MENU_SPACING)
        ...
        slider_fps = Slider(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, value=value)
        slider_fps.callback = slider_fps_update
        label_fps = Label(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        slider_fps_update()
        ...
        slider_text_resolution = Slider(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=1, value=value)
        slider_text_resolution.callback = slider_text_resolution_update
        label_text_resolution = Label(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=1, text="Text Resolution: " + str(window.options["text resolution"]), fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        if PLATFORM == "Darwin":
            button_fullscreen = Button(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, callback=button_fullscreen_update, text="Fullscreen: Disabled", fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        else:
            button_fullscreen = Button(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, callback=button_fullscreen_update, text="Fullscreen: False", fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        slider_particles = Slider(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=1, value=value)
        slider_particles.callback = slider_particles_update
        label_particles = Label(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=1, fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        button_show_fps = Button(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, callback=button_show_fps_update, text="Show Fps: " + str(window.options["show fps"]), fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        button_show_debug = Button(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=1, callback=button_show_debug_update, text="Show debug: " + str(window.options["show debug"]), fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        if window.options["antialiasing"]:
            ...
            value = 0
        slider_antialiasing = Slider(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=4, column=0, value=value)
        slider_antialiasing.callback = slider_antialiasing_update
        label_antialiasing = Label(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=4, column=0, fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        label_antialiasing.hover_callback = lambda: settings_video_hover(1,
            ...
            ("Set the level of antialiasing. Antialiasing creates smoother edges of shapes.", TEXT_SIZE_DESCRIPTION, (250, 250, 250, 200))
        )
        ...
        button_language = Button(settings_video_scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=4, column=1, callback=button_language_update, text="Language: " + window.options["language"].title(), fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        button_settings_back = Button(settings_video_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, callback=settings_page.open, text="Back", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        settings_video_page.layout()
        button_settings_video_open.callback = settings_video_page.open


        ###---###  Audio settings page  ###---###
        settings_audio_page = Page(parent=settings_page, columns=1, spacing=MENU_SPACING)
        ...
        slider_volume = Slider(settings_audio_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, value=value)
        slider_volume.callback = slider_volume_update
        label_volume = Label(settings_audio_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        slider_volume_update()

        Button(settings_audio_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, callback=settings_page.open, text="Back", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        settings_audio_page.layout()
        button_settings_audio_open.callback = settings_audio_page.open


        ###---###  World settings page  ###---###
        settings_world_page = Page(parent=settings_page, columns=1, spacing=MENU_SPACING)
        ...
        slider_simulation_distance = Slider(settings_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, value=value)
        slider_simulation_distance.callback = slider_simulation_distance_update
        label_simulation_distance = Label(settings_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=1, column=0, fontsize=TEXT_SIZE_OPTION, translator=self.translator)
        ...
        button_delete_world = Button(settings_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, callback=button_delete_world_update, text="Delete World", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)

        Button(settings_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, callback=settings_page.open, text="Back", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        ...
        label_delete_world = Label(delete_world_page, (MENU_BUTTON_WIDTH, 0.2), row=1, column=0, fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        button_delete_world_confirm = Button(delete_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=2, column=0, callback=button_delete_world_confirm_update, text="Delete my world!", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        Button(delete_world_page, (MENU_BUTTON_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, callback=settings_world_page.open, text="Cancel", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        ...
        scrollbox = ScrollBox(settings_control_page, (MENU_BUTTON_WIDTH + MENU_SPACING, 1), row=2, column=0, columnspan=2, columns=2, spacing=MENU_SPACING)
        ...
        for i, key in enumerate(keys):
            Label(scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=i, column=0, text=key.split(".")[1].title(), fontsize=TEXT_SIZE_TEXT, translator=self.translator)
            buttons[key] = Button(scrollbox, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=i, column=1, callback=lambda key=key: select_key(key), text=window.options[key].title(), duration=-1, fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
            buttons[key].key_identifer = key
        scrollbox.callback = update_key

        Button(settings_control_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=0, callback=settings_page.open, text="Back", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
        Button(settings_control_page, (MENU_BUTTON_SHORT_WIDTH, MENU_BUTTON_HEIGHT), row=3, column=1, callback=reset_keys, text="Reset", fontsize=TEXT_SIZE_BUTTON, translator=self.translator)
