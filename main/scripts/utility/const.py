...
BLOCKS_VEGETATION_FLOOR_UNCOMMON: tuple = ("tall_grass", "bush0", "bush1", "torch")
BLOCKS_VEGETATION_FLOOR_RARE: tuple = ("mushroom0", "mushroom1", "mushroom2", "mushroom3", "mushroom4", "mushroom5", "mushroom6", "plant0", "wood0", "bones0", "bones1", "bones2", "bones3", "stone0", "stone1", "stone2", "mossy_stone0", "mossy_stone1")
