...
BLOCKS_GRASS: tuple = ("flat_grass", "small_grass", "medium_grass", "tall_grass", "bush0", "bush1")
BLOCKS_MUSHROOM: tuple = ("mushroom0", "mushroom1", "mushroom2", "mushroom3", "mushroom4", "mushroom5", "mushroom6", "plant0",  "wood0")